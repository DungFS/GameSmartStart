...
def run_level1():
    ...
    img0 = pygame.image.load('img/level1/0-removebg-preview.png')
    img1 = pygame.image.load('img/level1/1-removebg-preview.png')
    img2 = pygame.image.load('img/level1/2-removebg-preview.png')
    img3 = pygame.image.load('img/level1/3-removebg-preview.png')
    img4 = pygame.image.load('img/level1/4-removebg-preview.png')
    img5 = pygame.image.load('img/level1/5-removebg-preview.png')
